...
const AboutSection = (props) => {
    ...
    return(
        ...
        <div className="w-100 app-flex-column py-5">
            ...
            <h1 className="font-36px text-black mb-3 text-center pt-3 heading-font">Know About Us</h1>
            <span className="font-16px text-black mb-5 text-center paragraph-font">
                ICO seemed to float in the middle of an immense dark sphere, whose upper half was strewn with silver.
            </span>

            <Row className="mx-0 p-0 mb-4 text-black">

                <Col xs={12} sm={12} md={6} lg={6} xl={6}>
                    <BorderBox className="border-box-about" adjust={true} feature>
                        <h6 className="pb-4 font-36px mt-2 heading-font">Great Blockchain Business Solutions For Blockchain Business</h6>
                        
                        <span className="w-100 text-justify mb-2 paragraph-font">
                        ...
                        <button className="gradient-apply border-0 connect-wallet text-white mt-3 mb-3 rounded font-weight-bold heading-font" style={{ width: '200px' }}>
                            Know About Ourself
                        </button>
                ...
                <Col xs={12} sm={12} md={6} lg={6} xl={6}>
                    <img alt="" width="100%" height="366px" src={Images.aboutImage} />
                </Col>
